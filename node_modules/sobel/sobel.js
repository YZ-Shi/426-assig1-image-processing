(function(root) {
  ...
  function Sobel(imageData) {
    ...
    var grad_x = new Array(width), grad_y = new Array(width);
    for (let i = 0; i < height; i++) {
      grad_x[i] = new Array(height);
      grad_y[i] = new Array(height);
    }
    ...
    for (y = 0; y < height; y++) {
      for (x = 0; x < width; x++) {
        ...
        //sobelData.push(pixelX, pixelY, magnitude, 255);
    ...
    const result = [];
    result.push(clampedArray);
    //result.push(grad_x);
    //result.push(grad_y);

    //return [clampedArray, grad_x, grad_y];
    return clampedArray;
    //console.log(result);
    //debugger;
    //return result;
